...
const Dashboard = () => {
  ...
  const planilhaLinks = {
    "Apoio Filial_16":
      "https://docs.google.com/spreadsheets/d/1exemplo_apoio_filial_16/edit#gid=0",
    Técnico_66:
      "https://docs.google.com/spreadsheets/d/1exemplo_tecnico_66/edit#gid=0",
    Técnico_06:
      "https://docs.google.com/spreadsheets/d/1exemplo_tecnico_06/edit#gid=0",
  };
  ...
  const mockScripts = [
    {
      ...
      content:
        "Olá! Seja bem-vindo(a) ao suporte Prosegur. Meu nome é [NOME]. Como posso ajudá-lo(a) hoje? Por favor, me informe seu nome completo e o número do cofre para que eu possa localizar suas informações no sistema.",
    },
    {
      title: "Suporte Técnico",
      content:
        "Entendo sua situação. Vou orientá-lo(a) passo a passo para resolver este problema técnico. Primeiro, verifique se o cofre está conectado à energia elétrica. Em seguida, pressione o botão RESET por 5 segundos. Aguarde o sinal sonoro duplo antes de inserir a senha.",
    },
    {
      title: "Vendas",
      content:
        "Obrigado pelo interesse em nossos produtos Prosegur! Temos diversas opções de cofres que atendem desde residências até grandes empresas. Qual o tipo de estabelecimento e qual o nível de segurança que você necessita? Com base nisso, posso recomendar o modelo ideal.",
    },
    {
      title: "Pós-venda",
      content:
        "Agradecemos por escolher a Prosegur! Para garantir que você tenha a melhor experiência com seu cofre, oferecemos suporte 24h, manutenção preventiva gratuita no primeiro ano e garantia total de 3 anos. Você tem alguma dúvida sobre o funcionamento do seu equipamento?",
    },
  ];
  ...
  const copyCadastroCompleto = (cadastro) => {
    const texto = `${cadastro.nome} ${cadastro.sobrenome} - Matrícula: ${
      cadastro.matricula
    } - ${cadastro.perfil} - ${
      cadastro.comSenha === "sim" ? "Com senha" : "Sem senha"
    }`;
  ...
  const copyTodosCadastros = () => {
    const textos = cadastros.map((cadastro, index) => {
      return `${cadastro.nome} ${cadastro.sobrenome} - Matrícula: ${
        cadastro.matricula
      } - ${cadastro.perfil} - ${
        cadastro.comSenha === "sim" ? "Com senha" : "Sem senha"
      }`;
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                Gerencie e monitore todos os cofres corporativos
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <Card
                  key={item}
                  className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-yellow-500"
                >
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-center">
                      <Badge
                        variant="outline"
                        className="border-yellow-500 text-black"
                      >
                        Modelo X{item}5
                      </Badge>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {manuais.map((manual, index) => (
                <Card
                  key={index}
                  className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-red-800"
                >
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        value={manual.nome}
                        onChange={(e) =>
                          updateManual(index, "nome", e.target.value)
                        }
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            copyManualField(`**${manual.cnpj}**`, "CNPJ")
                          }
                          className="h-6 w-6 p-0 hover:bg-yellow-50"
                        >
                          <Copy className="h-3 w-3" />
                      ...
                      <div className="flex items-center border rounded-md px-3 py-2 text-sm">
                        ...
                        <input
                          value={manual.cnpj}
                          onChange={(e) =>
                            updateManual(index, "cnpj", e.target.value)
                          }
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            copyManualField(manual.telefone, "Telefone")
                          }
                          className="h-6 w-6 p-0 hover:bg-yellow-50"
                        >
                          <Copy className="h-3 w-3" />
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateManual(index, "telefone", e.target.value)
                        }
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            copyManualField(manual.motivo, "Motivo")
                          }
                          className="h-6 w-6 p-0 hover:bg-yellow-50"
                        >
                          <Copy className="h-3 w-3" />
                      ...
                      <textarea
                        value={manual.motivo}
                        onChange={(e) =>
                          updateManual(index, "motivo", e.target.value)
                        }
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                Templates e scripts para atendimento
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {mockScripts.map((script, index) => (
                <Card
                  key={index}
                  className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-green-600"
                >
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                    ...
                    <CardDescription>
                      Script padrão para {script.title.toLowerCase()}
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                Perguntas frequentes e planilhas de apoio
              </p>
            </div>
            ...
            <Card className="border-l-4 border-l-yellow-500">
              <CardHeader>
                ...
                <CardDescription>
                  Digite o nome da cidade para encontrar em qual planilha ela
                  está localizada
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <div>
              ...
              */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {["Apoio Filial_16", "Técnico_66", "Técnico_06"].map(
                  (sheet, index) => (
                    <Card
                      key={index}
                      className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-yellow-500 cursor-pointer"
                      onClick={() => handleExcelDownload(sheet)}
                    >
                      ...
                      <CardContent>
                        ...
                        <div className="mt-3 text-xs text-gray-500">
                          Cidades incluídas:{" "}
                          {mockCities[sheet]?.slice(0, 2).join(", ")}...
                        </div>
                      </CardContent>
                    </Card>
                  )
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyCadastroField(cadastro.nome, "Nome")
                            }
                            className="h-6 w-6 p-0 hover:bg-yellow-50"
                          >
                            <Copy className="h-3 w-3" />
                        ...
                        <Input
                          value={cadastro.nome}
                          onChange={(e) =>
                            updateCadastro(index, "nome", e.target.value)
                          }
                          placeholder="Digite o nome"
                          className="text-sm"
                        />
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyCadastroField(cadastro.sobrenome, "Sobrenome")
                            }
                            className="h-6 w-6 p-0 hover:bg-yellow-50"
                          >
                            <Copy className="h-3 w-3" />
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateCadastro(index, "sobrenome", e.target.value)
                          }
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyCadastroField(cadastro.matricula, "Matrícula")
                            }
                            className="h-6 w-6 p-0 hover:bg-yellow-50"
                          >
                            <Copy className="h-3 w-3" />
                        ...
                        <p className="text-xs text-gray-500">
                          {cadastro.matricula.length}/9 caracteres
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            updateCadastro(index, "perfil", e.target.value)
                          }
  ...
  return (
    <div className="min-h-screen p-4 all">
      {/* Desktop Sidebar */}
        ...
        <div className="flex flex-col h-full w-full bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl border border-white/50">
          ...
          <nav className="flex-1 p-4 xl:p-6 space-y-2 xl:space-y-3">
            {navigation.map((item) => {
              ...
              return (
                ...
                >
                  <div
                    className={`p-1.5 xl:p-2 rounded-xl transition-all duration-300 ${
                      activeSection === item.id
                        ? "bg-black/10"
          ...
          <div className="p-4 xl:p-6 border-t border-gray-100">
            <div className="bg-gray-50 rounded-2xl p-3 xl:p-4 text-center">
              <p className="text-xs text-gray-500 font-medium">Versão 2.2</p>
              <p className="text-xs text-gray-400 mt-1"><a href="https://www.instagram.com/dev.thigas/" target="blank" className="hover:underline">Thiago</a> e <a href="https://www.instagram.com/yrdsniel/" target="blank" className="hover:underline">Daniel</a> © 2025</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Mobile Sidebar */}
      <div
        className={`lg:hidden fixed inset-y-0 right-0 z-40 w-96 transform transition-transform duration-300 ease-in-out ${
